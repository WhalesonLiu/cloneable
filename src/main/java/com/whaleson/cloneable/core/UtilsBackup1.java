                    ...
                    try {
                        if (targetField != null) {
                            if(sourceFieldValue instanceof List){
                                ...
                                /*Type t = targetField.getGenericType();
                                ...
                                if(targetFieldObject == null){
                                    targetFieldObject = new ArrayList<>();
                                }
                                System.out.println("998\t" + targetFieldObject);
                                /*ListIterator<Object> elementObject = ((List) sourceFieldValue).listIterator();
                                System.out.println(elementObject);*/

                                /*while (elementObject.hasNext()){
                                    System.out.println(elementObject.next());
                                }*/



                                /*((List) sourceFieldValue).listIterator().forEachRemaining(e ->{
                                    try {
                                        Object listTargetElement = targetField.getDeclaringClass().newInstance();
                                        copyPropertiesByReflect(e,listTargetElement);
                                        //((List)targetFieldObject).add(listTargetElement);
